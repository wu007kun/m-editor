  ...
  function update (object) {
    ...
    if (geometry) {
      ...
      if (index !== null) {
        ...
        containerAttributes.add(new UIText(formatNumber(index.count)).setFontSize('12px'))
      ...
      for (const name in attributes) {
        ...
        containerAttributes.add(new UIText(formatNumber(attribute.count) + ' (' + attribute.itemSize + ')').setFontSize('12px'))
        containerAttributes.add(new UIBreak())
      }
      ...
      if (hasMorphTargets === true) {
        ...
        for (const name in morphAttributes) {
          ...
          containerMorphAttributes.add(new UIText(formatNumber(morphTargets.length)).setFontSize('12px'))
