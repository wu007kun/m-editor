...
const { unzipSync, strFromU8 } = THREE.FFlate
    ...
    switch (extension) {
...

      {
        reader.addEventListener('load', async function (event) {
          ...
          loader.setLibraryPath('/thirdparty/rhino3dm/')
...

      {
        reader.addEventListener('load', async function (event) {
          ...
          loader.ifcManager.setWasmPath('/thirdparty/ifc/')
